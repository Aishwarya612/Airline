        ...
        <div class="py-5" style={{backgroundImage: `url(${planeBG})`,overflow: 'hidden', height: '900px'}}>
            <div class="row mb-4">
                <div class="col-lg-8 mx-auto text-center">
                    <h1 class="font-weight-bold" style={{color:'black', fontWeight:'80pt'}}>Add Passenger Details</h1>
                </div>
            </div>
                        ...
                        <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                            ...
                            {this.state.info && <div class="alert alert-success">
                                ...
                                <form>
                                    ...
                                    <div class="checkbox">
                                        <label><input  onClick={this.click} type="checkbox" value="checkbox" required />&nbsp; <a href="#" data-toggle="modal" data-target="#myModal">Agree Terms and Conditions</a></label>
                                    </div>
