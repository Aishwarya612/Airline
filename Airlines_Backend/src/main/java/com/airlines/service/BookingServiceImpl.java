...
import com.airlines.dao.BookingRepository;
import com.airlines.dao.PassengerRepository;
import com.airlines.dao.TicketRepository;
import com.airlines.dao.UserRepository;
...
public class BookingServiceImpl implements BookingService {
	...
	//this method retrieves all the Passengers based on user id
		@Override
		public List<Passenger> getPassenger(int fno) {
			
			List<Passenger> plist=prepo.findByFlightNo(fno);
			return plist;
		}
