...
import com.airlines.bean.ListPassenger;
...
//		int bid = bookservice.addBooking(booking);
	...
	//Get request for fetching Passenger 
		@GetMapping(value="/getPassenger/{fno}" ,produces = "application/json")
		public List<Passenger> getPassenger(@PathVariable int fno) {
		
			return bookservice.getPassenger(fno);
